document.addEventListener("DOMContentLoaded", () => {
  ...
  summarizeBtn.addEventListener("click", async () => {
    ...
    summarizeBtn.classList.add("button--loading"); //
    ...
    try {
      ...
      if (
        ...
        summaryOutput.innerHTML = marked.parse(injectionResults[0].result);
      } else {
      ...
      summarizeBtn.classList.remove("button--loading");
    }
  });
});
